...
Using FFDQ, a report like this could be modeled as a MultiRecord or Dataset level assertion. Another example using FFDQ is a report that shows the percentage of records that satisfy some set of validations before and after the amendments stage.
