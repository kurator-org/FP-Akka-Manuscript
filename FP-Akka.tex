...
\maketitle
\begin{abstract}
%Depending on their purpose for use of a large collection of natural science  data sets,
%such a user may be satisfied with data quality reports that allow inclusion or
%exclusion of subsets of the data from their use. 
...
% \citep{McPhillips2015} markup of the workflow class.  
...
%an off by a factor of ten error in decimal latitude and longitude values.
